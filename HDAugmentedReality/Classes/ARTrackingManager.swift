...
//    @objc optional func arTrackingManager(_ trackingManager: ARTrackingManager, didUpdateReloadLocation location: CLLocation)
//    @objc optional func arTrackingManager(_ trackingManager: ARTrackingManager, didFailToFindLocationAfter elapsedSeconds: TimeInterval)
//    @objc optional func arTrackingManager(_ trackingManager: ARTrackingManager, didRangeBeacons beacons: [CLBeacon], in region: CLBeaconRegion)
//
//    @objc optional func logText(_ text: String)
//}
//
...
//        if(!useGPS){
//
//            // inja bayad az ruye noqate globalfields.indoorpoints locatione khodemun mohasbe beshe
//            // ba tavajoh b faseleye ma az beaconha
//            // k faseleye ma az beaconha bayad az ruye ye functione dg dar biad
//            // agar beaconhayi k peyda shodan kamtar az se adad budan return mishe
//            // pas az b dast avordane faseleha bayad seta nazdiktarin beaconha malum beshe
//            // bad az inke seta nazdiktarina moshakhas shod mohasebeye location beshe
//
//            if(beacons.count < 3){
//
//                return
...
//            for b in beacons {
//
//                for indoor in GlobalFields.indoorPoints {
//
//                    if(indoor.beacon_code == GlobalFields.getCodeOf(beacon: b) && b.rssi != -1){
//
//                        count += 1
//
//                    }
...
//            }
//
//            // alan hatman seta beacon darim k dar range hastan
//            // hala bayad setaye nazdik entekhab beshan vase mohasebeye location
//
//            var tempBeacons : [CLBeacon] = beacons
//            var minDistanceBeacons : [CLBeacon] = [CLBeacon]()
//
//
//            for _ in beacons {
//                count = -1
//                for i in 0...tempBeacons.count-1 {
//
//                    if(tempBeacons[i].rssi != 0){
//
//                        count = i
//                        break
//
...
//                    break
//                }
//                var min : CLBeacon = tempBeacons[count]
//                count = 0
//                var count2 : Int = 0
//                for b in  tempBeacons {
//                    if(b.rssi > min.rssi && b.rssi != 0){
//
//                        min = b
//                        count2 = count
//                    }
...
//
//                }
//                minDistanceBeacons.append(min)
//                tempBeacons.remove(at: count2)
//
//            }
//
//            var resMin : [GlobalFields.indoorPoint] = []
//            tempBeacons.removeAll()
//
//            for m in minDistanceBeacons {
//
//                for indoor in GlobalFields.indoorPoints {
//
//                    if(indoor.beacon_code == GlobalFields.getCodeOf(beacon: m)){
//
//                        resMin.append(indoor)
//                        tempBeacons.append(m)
//
//                    }
//
//                }
...
//
//
//            // alan dakhele minDistanceBeacons setaye nazdik vojud dare hatman
//            // hala bayad az methode centerOfBeacons estefade besheo locatione user b dast biad
//            print("+++++++++++")
//            print(resMin[0].x , "*" ,resMin[0].y)
//            print(resMin[1].x , "*" ,resMin[1].y)
//            print(resMin[2].x , "*" ,resMin[2].y)
//            print()
//            print(GlobalFields.distanceTo(beacon: tempBeacons[0]))
//            print(GlobalFields.distanceTo(beacon: tempBeacons[1]))
//            print(GlobalFields.distanceTo(beacon: tempBeacons[2]))
//            print("@@@@@@@@@@@")
//            print(tempBeacons[0].rssi)
//            print(tempBeacons[1].rssi)
//            print(tempBeacons[2].rssi)
//            print("@@@@@@@@@@@")
//
//            let c = GlobalFields.getCenterOfThreeCircle(s1: resMin[0], s2: resMin[1], s3: resMin[2], d1: GlobalFields.distanceTo(beacon: tempBeacons[0]), d2: GlobalFields.distanceTo(beacon: tempBeacons[1]), d3: GlobalFields.distanceTo(beacon: tempBeacons[2]))
//
//            if(c != nil){
//
//                let loc = GlobalFields.findCoordinate(p: c!)
//                print(c?.x)
//                print(c?.y)
//                print("^^^^^")
//                print(loc.latitude)
...
//                print()
//
//                let location : CLLocation = CLLocation.init(latitude: loc.latitude, longitude: loc.longitude)
//
//                //===== Disregarding old and low quality location detections
//                let age = location.timestamp.timeIntervalSinceNow;
//                if age < -self.minimumLocationAge || location.horizontalAccuracy > self.minimumLocationHorizontalAccuracy || location.horizontalAccuracy < 0
