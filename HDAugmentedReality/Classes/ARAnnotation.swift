...
//    open var title: String?
//
//    open var uuid_major_minor : String?
//
//    open var x : Double!
//
//    open var y : Double!
...
//     Returns annotation if location(coordinate) is valid.
//     */
//    public init?(identifier: String?, title: String?, location: CLLocation , uuid_major_minor : String? , x : Double , y : Double , z : Double)
//    {
//        guard CLLocationCoordinate2DIsValid(location.coordinate) else { return nil }
//
//        self.identifier = identifier
//        self.title = title
//        self.location = location
//        self.uuid_major_minor = uuid_major_minor
//        self.x = x
//        self.y = y
//        self.z = z
//
