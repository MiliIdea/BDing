...
//    }
//
//    internal func arTrackingManager(_ trackingManager: ARTrackingManager, didRangeBeacons beacons: [CLBeacon], in region: CLBeaconRegion)
//    {
//
//        if(!useGPS){
//
...
//
//            for _ in beacons {
//                var min : CLBeacon = tempBeacons.first!
//                count = 0
...
//
//            let loc = GlobalFields.findCoordinate(p: GlobalFields.getCenterOfThreeCircle(s1: resMin[0], s2: resMin[1], s3: resMin[2], d1: GlobalFields.distanceTo(beacon: tempBeacons[0]), d2: GlobalFields.distanceTo(beacon: tempBeacons[1]), d3: GlobalFields.distanceTo(beacon: tempBeacons[2]))!)
//
