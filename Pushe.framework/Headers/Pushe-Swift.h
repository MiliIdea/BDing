...
SWIFT_MODULE_NAMESPACE_PUSH("Pushe")
@class UNUserNotificationCenter;
@class UNNotificationResponse;
@class UNNotification;

SWIFT_CLASS("_TtC5Pushe5Pushe")
@interface Pushe : NSObject <GCMReceiverDelegate, GGLInstanceIDDelegate, UNUserNotificationCenterDelegate>
...
- (NSString * _Nonnull)getPusheId SWIFT_WARN_UNUSED_RESULT;
- (void)connectToGcm;
